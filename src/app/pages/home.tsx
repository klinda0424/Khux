  ...
  return (
    <div className="w-full">
      ...
      <section id="about" className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        ...
        <FadeInSection>
          <div className="mt-20">
            <h3 className="text-xl sm:text-2xl mb-6 text-primary">KHUX Culture</h3>
      ...
      <section className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Direction & Goals</h2>
        </FadeInSection>
      ...
      <section className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Activity Areas</h2>
          <p className="text-base text-text-sub leading-relaxed max-w-2xl">
      ...
      <section id="articles" className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Articles</h2>
      ...
      <section id="activities" className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Activities</h2>
          <p className="text-base text-text-sub leading-relaxed max-w-2xl mb-10">
      ...
      <section id="gallery" className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Gallery</h2>
          <p className="text-base text-text-sub leading-relaxed max-w-2xl mb-10">
      ...
      <section id="notice" className="py-28 max-w-[1200px] mx-auto px-6 sm:px-12">
        <FadeInSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Notice</h2>
          <p className="text-base text-text-sub leading-relaxed max-w-2xl mb-10">
          ...
          <section className="py-28">
            <FadeInSection>
              <div className="max-w-[1200px] mx-auto px-6 sm:px-12 text-center">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-6 text-primary">Grow With KHUX</h2>
